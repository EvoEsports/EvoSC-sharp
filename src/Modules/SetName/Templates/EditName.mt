<component>
    ...
    <template>
        <frame pos="-25 9" valign="center" halign="center">
            ...
            <label pos="1 -1" text="{{ Locale.PlayerLanguage.UI_EditYourNickname }}" textsize="1.5" />
            ...
            <FormEntry
                    ...
                    y="-6"
            />
            <FormSubmit x="25" y="-14" text="{{ Locale.PlayerLanguage.UI_Submit }}" action="SetName/EditName" />
            <FormSubmit x="37" y="-14" text="{{ Locale.PlayerLanguage.UI_Cancel }}" action="SetName/Cancel" />
        </frame>
    </template>
</component>
