<component>
    ...
    <property type="string" name="score" default="0" />
    ...
    <template>
        <frame pos="0 {{ y }}">
            ...
            <label pos="65 -2.5" z-index="3" size="15 5" text="{{ score }}" valign="center2" textfont="GameFontSemiBold" textsize="1" textprefix="$i$t" halign="center"/>
