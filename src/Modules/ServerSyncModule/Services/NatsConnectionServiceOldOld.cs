...
public class NatsConnectionServiceOldOld(
    INatsSettings natsSettings,
    IServerClient tmServer,
    ILogger<NatsConnectionServiceOldOld> logger)
    : INatsConnectionServiceOld
{
    ...
    public async Task ConnectAsync()
    {
        ...
        logger.LogInformation("Connecting to {ConnectionUrl} with subjectprefix {SubjectPrefix}...", natsSettings.GetConnectionUrl(),
            subjectPrefix);
        ...
        logger.LogInformation("Connected to NATS server at {Url} with stream name {StreamName}", options.Url,
